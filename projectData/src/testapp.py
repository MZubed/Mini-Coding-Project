'''TESTING PLAN: 1) ADD UNIT TEST FOR CSV FILE OPENING TO CHECK IF IT OPENS IN THE FIRST PLACE
2) ADD UNIT TEST FOR INPUT FOR USER INPUT TO SEE IF USER INPUT GOES TO THE CORRECT FUNCTION OR NOT 
'''
...
#LOADING COURIERS
with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/couriers.txt','r') as file:
    courierReader=csv.DictReader(file)
    couriersList=[couriers for couriers in courierReader]
    print(couriersList)

#LOADING PRODUCTS
with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/products.txt','r') as file:
    productReader=csv.DictReader(file)
    productsList=[products for products in productReader]
    print(productsList)

#LOADING ORDERS
with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/orders.txt','r') as file:
...
\n4-Couriers Menu\n")
            if menu.strip() == '1':
                print('Exiting App')
                productsList
                with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/products.txt','w',newline='') as file:
                    fieldnames=['product','price']
                    writer=csv.DictWriter(file,fieldnames=fieldnames)
                    writer.writeheader()
                    writer.writerows(productsList)
                with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/couriers.txt','w',newline='') as file:
                    fieldnames=['courier name','courier phone']
                    writer=csv.DictWriter(file,fieldnames=fieldnames)
                    writer.writeheader()
                    writer.writerows(couriersList)
                with open('C:/Users/mzube/Downloads/copyOfProject/Mini-Coding-Project/projectData/data/orders.txt','w',newline='') as file:
